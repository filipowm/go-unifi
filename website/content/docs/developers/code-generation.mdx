...
- The Official pass is additionally guarded by determinism / committed-surface / round-trip tests
  (`TestSurfaceMatchesCommitted`, `TestSurfaceDeterministic`, `models_roundtrip_test.go`).
