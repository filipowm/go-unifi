---
title: Official API
description: The c.Official() surface — the controller's own integration/v1 OpenAPI, addressed by site UUID - fluent per-group clients, the uniform method shape, and the ListOptions / Page / Collect pagination primitives.
---

The **Official API** is the controller's own [UniFi Network API](https://developer.ui.com)
...
[`ErrOfficialAPIUnavailable`](/docs/reference/errors) or `ErrOfficialAPIDisabled`. See
