...
func init() { //nolint:gochecknoinits
	registerSetting(SettingDpiKey, func() any { return &SettingDpi{} })
}
...
func (c *client) GetSettingDpi(ctx context.Context, site string) (*SettingDpi, error) {
	...
	resource, ok := f.(*SettingDpi)
	if !ok {
		return nil, fmt.Errorf("unexpected type for setting value. expected: *SettingDpi, received: %T", f)
	}
	return resource, nil
}
...
func (c *client) UpdateSettingDpi(ctx context.Context, site string, s *SettingDpi) (*SettingDpi, error) {
	...
	updatedResource, ok := result.(*SettingDpi)
	if !ok {
		return nil, fmt.Errorf("unexpected type for setting value. expected: *SettingDpi, received: %T", result)
	}
