...
type SettingMdnsPredefinedServices struct {
	Code string `json:"code,omitempty" validate:"omitempty,oneof=amazon_devices apple_airDrop apple_airPlay apple_file_sharing apple_iChat apple_iTunes dns_service_discovery ftp_servers google_chromecast homeKit matter_network printers scanners spotify_connect ssh_servers web_servers windows_file_sharing_samba"` // amazon_devices|apple_airDrop|apple_airPlay|apple_file_sharing|apple_iChat|apple_iTunes|dns_service_discovery|ftp_servers|google_chromecast|homeKit|matter_network|printers|scanners|spotify_connect|ssh_servers|web_servers|windows_file_sharing_samba
}
