...
// - client.go: contains client, ClientConfig, newClientInternal, NewClient, NewBareClient etc.
// - api_paths.go: contains API path constants and ApiPaths struct definitions.
// - interceptors.go: contains interceptor interface and implementations (ApiKeyAuthInterceptor, DefaultHeadersInterceptor).
